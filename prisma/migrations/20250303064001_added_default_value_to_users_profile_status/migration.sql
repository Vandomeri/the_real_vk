...
INSERT INTO "new_users_profile" ("aboutMe", "city", "country", "dateOfBirth", "id", "sex", "status", "usersId") SELECT "aboutMe", "city", "country", "dateOfBirth", "id", "sex", "status", "usersId" FROM "users_profile";
